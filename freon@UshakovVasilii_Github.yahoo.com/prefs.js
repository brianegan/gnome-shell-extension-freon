...
var FreonPrefsWidget = new GObject.registerClass(
    class Freon_FreonPrefsWidget extends Gtk.Grid {
        _init() {
            super._init();
            ...
            this._addSwitch({
                key: "group-temperature",
                y: i,
                x: 0,
                label: _("Group Temperature Items"),
                help: _(
                    "Works if you have more than three temperature sensors"
                ),
            });
        ...
        _addComboBox(params) {
            ...
            combobox.set_active(
                Object.keys(params.items).indexOf(
                    this._settings.get_string(params.key)
                )
            );
